...
# True: to block of 32 slices at once, else slice-wise reconstruction
doBlock = False
...
def load_projection_block(_projdir, _b, _blocksize, _sx, _ip180, _typ):
    ...
    _projblock = np.empty((_blocksize, _sx, _ip180), _typ)
    ...
    print('read projections: %.2f sec ' % execution_time)
    return _projblock
